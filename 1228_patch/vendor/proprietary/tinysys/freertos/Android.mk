...
TINYSYS_SCP_BUILD_CMD := \
	...
	O=$(abspath $(TINYSYS_BUILT_INTERMEDIATES)) \
	INSTALLED_DIR=$(abspath $(PRODUCT_OUT)) \
...
$(TINYSYS_CONFIG_HEADER):
	$(MAKE) $(TINYSYS_SCP_BUILD_CMD) configheader
...
.KATI_RESTAT: $(TINYSYS_INSTALLED_TARGET)
$(TINYSYS_INSTALLED_TARGET): check-tinysys-config $(TINYSYS_SCP_CHRE_LINK)
	$(MAKE) $(TINYSYS_SCP_BUILD_CMD)
...
$(TINYSYS_CLEAN_MODULE):
	...
	$(MAKE) $(TINYSYS_SCP_BUILD_CMD) clean
...
$(TINYSYS_INSTALLED_TARGET) $(TINYSYS_CONFIG_HEADER): $(TINYSYS_CLEAN_MODULE)
endif
