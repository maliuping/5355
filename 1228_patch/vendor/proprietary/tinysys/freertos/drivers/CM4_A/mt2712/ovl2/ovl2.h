...
int32_t ovl2_config(video_handle p_inst,
	video_config_type type, void *config);
int32_t ovl2_commit(video_handle p_inst,
	video_buffer_type type, video_buffer *buffer);
