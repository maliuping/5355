...
/* #define traceMALLOC( addr, size ) printf("\n\r [malloc] size:%d, addr:0x%x, remain:%d\n\r", size, addr, xPortGetFreeHeapSize()); */
/* #define traceFREE( addr, size ) printf("\n\r [free] size:%d, addr:0x%x\n\r", size, addr); */
/* Define debug level*/
/* #define LOG_DEBUG  3
 * #define LOG_INFO   2
 * #define LOG_WARN   1
